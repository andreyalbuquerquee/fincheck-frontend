...
export function DropdownMenuItem({children}: {children: React.ReactNode}) {
    return (
        <RdxDropdownMenu.Item className="outline-none min-h-[48px] flex items-center p-4 text-gray-800 text-sm cursor-pointer hover:bg-gray-100 rounded-2xl transition-colors">
            {children}

       ...
       <div>
         <DropdownMenu.Root>
            <DropdownMenu.Trigger>
                ...
                <button className={cn('w-full bg-white rounded-lg border border-gray-500 px-3 h-[52px] text-gray-700 outline-none focus:border-gray-800 transition-all text-left relative', 

    ...
    return (
        <div className="flex h-full w-full">
            ...
            <div className="w-1/2 h-full justify-center items-center p-8 relative hidden lg:flex">
                ...
                <div className="absolute mx-8 max-w-[656px] bottom-8 bg-white p-10 rounded-b-[32px]">
                    <Logo className="text-teal-900 h-8"/>
                    <p className="text-gray-700 font-medium text-xl mt-6">Gerencie suas finanças pessoais de uma forma simples 
